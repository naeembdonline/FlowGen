...
# ============================================================================
# FIKERFLOW LEAD SAAS - COMPLETE SERVER DEPLOYMENT SCRIPT
# Run this on your Ubuntu server: sudo bash deploy-to-server.sh
# ============================================================================
...
echo -e "${BLUE}============================================================================${NC}"
echo -e "${BLUE}  FIKERFLOW LEAD SAAS - AUTOMATED SERVER DEPLOYMENT${NC}"
echo -e "${BLUE}============================================================================${NC}\n"
...
mkdir -p /root/fikerflow-lead-saas/{backend/src,frontend/src,logs,backups,ssl}
cd /root/fikerflow-lead-saas
...
if [ ! -f "docker-compose.production.yml" ]; then
    ...
    echo -e "${YELLOW}Please upload your project files to /root/fikerflow-lead-saas${NC}"
    exit 1
fi
...
if [ ! -f "backend/.env" ]; then
    ...
    if [ -f "backend/.env.production.template" ]; then
        ...
        echo -e "${YELLOW}Run: nano /root/fikerflow-lead-saas/backend/.env${NC}"
...
# ============================================================================
echo -e "${YELLOW}[4/9] Creating Nginx configuration...${NC}"
...
# ============================================================================
echo -e "${YELLOW}[5/9] Obtaining SSL certificate...${NC}"

if certbot certonly --webroot -w /var/www/html \
    -d leads.naeemmia.bd \
    -d www.leads.naeemmia.bd \
    --email admin@fikerflow.com \
    --agree-tos \
    --no-eff-email \
...
# ============================================================================
# STOP OLD FIKERFLOW CONTAINERS
# ============================================================================
echo -e "${YELLOW}[6/9] Stopping old Fikerflow containers...${NC}"
...
echo -e "${YELLOW}Your Fikerflow SaaS is now live at:${NC}"
echo -e "  ${GREEN}https://leads.naeemmia.bd${NC}"
echo -e "  ${GREEN}https://leads.naeemmia.bd/health${NC}\n"

echo -e "${YELLOW}Useful Commands:${NC}"
echo -e "  View logs: ${BLUE}docker-compose -f /root/fikerflow-lead-saas/docker-compose.production.yml logs -f${NC}"
echo -e "  Restart:   ${BLUE}docker-compose -f /root/fikerflow-lead-saas/docker-compose.production.yml restart${NC}"
echo -e "  Stop all:  ${BLUE}docker-compose -f /root/fikerflow-lead-saas/docker-compose.production.yml stop${NC}\n"
